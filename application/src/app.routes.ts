...
export const routes: Routes = [
  ...
  { path: 'system', redirectTo: 'system/landing', pathMatch: 'full' },
  { path: 'system/landing', loadComponent: () => import('./pages/system-landing/system-landing.component').then(m => m.SystemLandingComponent), title: 'System | fireCNC' },
  ...
  { path: 'information/hardware/power-supply-idealplusing', loadComponent: () => import('./pages/power-supply-idealplusing/power-supply-idealplusing.component').then(m => m.PowerSupplyIdealplusingComponent), title: 'Idealplusing IDP-240-24 | fireCNC' },
  { path: 'information/hardware/distribution-panel-relay', loadComponent: () => import('./pages/distribution-panel-relay/distribution-panel-relay.component').then(m => m.DistributionPanelRelayComponent), title: 'Distribution Panel Relay | fireCNC' },
  ...
  { path: 'information/hardware/sp902e-repeater', loadComponent: () => import('./pages/sp902e-repeater/sp902e-repeater.component').then(m => m.Sp902eRepeaterComponent), title: 'SP902E SPI Repeater | fireCNC' },
